...
from band.client import get_pm_client, get_quant_client
...
async def run_full_pipeline(
    ...
    # ═══════════════════════════════════════════════════════════
    # PHASE 2: Data Cave — Quant Agent fetches data
    # ═══════════════════════════════════════════════════════════
    ...
    final_memo = await call_llm(
        system_prompt=pm_system_prompt(),
        user_prompt=pm_final_memo_prompt(ticker, quant_summary, bull_arg, bear_arg),
        provider="aiml",
        temperature=0.5,
        max_tokens=3000,
    )
